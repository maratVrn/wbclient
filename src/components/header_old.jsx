...
const HeaderOld = () => {
    ...
    return (
        ...
        <header className={isHeaderActive ? 'header is-active' : 'header'} style={{backgroundColor: '#f8f8f8'}}>
            <div className="border-1" style={{width:'100px', height:'100px' }}>

            </div>

            <div className="border-1 header-desktop container-fluid" style={{paddingLeft:'60px'}}>
            ...
            <div className="header-mobile"><a className="header-logo" href="/">
                <img
