                    ...
                    <div className="flex-container">
                        <div className="step-wrapper">
                            ...
                            <div className="step-content">
                                ...
                                <p className="step-description">
                                    Найдите интересующие вас товары на нашем сайте. Для этого можно вставить ID товара Wildberries или прдемет в строку поиска, выбрать товар и перейти в его статистику.
                                </p>
                            </div>
                        </div>
